...
init python:
    ...
    class Puzzle(object):
        ...
        def __init__(self):
            ...
            self.table = t = Table(base="images/puzzle/card/base.png", back="images/puzzle/card/base.png")
            ...
            for i in range(0, self.COL_NUM):
                for j in range(0, self.ROW_NUM):
                    value = (i, j)
                    if puzzle_number == 1:
                        t.card(value, "images/puzzle/card/room-%d-%d.jpg" % (i,j))
                    if puzzle_number == 2:
                        t.card(value, "images/puzzle/card1/room-%d-%d.png" % (i,j))
                    if puzzle_number == 3:
                        t.card(value, "images/puzzle/card2/room-%d-%d.jpg" % (i,j))
