...
screen map:
    ...
    imagebutton:
        auto "images/map_%s.png" action Return("map")alt"map"
        align(.98,.01)
...
screen navigation():
    ...
    vbox:
        ...
        if main_menu:
            ...
            imagebutton auto "images/knopki/button1_%s.png" xpos 0 ypos 0 action Start()

            imagebutton auto "images/knopki/button11_%s.png" ypos 0.15 action ShowMenu('gallery')

        else:

            imagebutton auto "images/knopki/button7_%s.png" action ShowMenu("history")

            imagebutton auto "images/knopki/button8_%s.png" xpos 0 ypos 10 action ShowMenu("save")

        imagebutton auto "images/knopki/button2_%s.png" xpos 0 ypos 20 action ShowMenu("load")

        imagebutton auto "images/knopki/button3_%s.png" xpos 0 ypos 40  action ShowMenu("preferences")
        ...
        if _in_replay:
            ...
            imagebutton auto "images/knopki/button9_%s.png" xpos 0 ypos 51 action MainMenu()

        imagebutton auto "images/knopki/button5_%s.png" xpos 0 ypos 60 action ShowMenu("about")

        if renpy.variant("pc"):

            ## Помощь не необходима и не относится к мобильным устройствам.
            imagebutton auto "images/knopki/button4_%s.png" xpos 0 ypos 80 action ShowMenu("help")

            ## Кнопка выхода блокирована в iOS и не нужна на Android.
            imagebutton auto "images/knopki/button6_%s.png" xpos 0 ypos 100 action Quit(confirm=not main_menu)
...
screen main_menu():
    ...
    ## Это гарантирует, что любой другой экран будет заменён.
    tag menu
...
## Экран игрового меню #########################################################
##
## Этот показывает основную и общую структуру экрана игрового меню. Он
## вызывается с экраном заголовка, и показывает фон, заголовок и навигацию.
##
## Параметр scroll может быть None, или одним из "viewport" или "vpgrid", когда
## этот экран предназначается для использования с одним или больше дочерними
## экранами, которые включены в него.
...
screen game_menu(title, scroll=None):
    ...
    imagebutton auto "images/knopki/button10_%s.png":
        style "return_button"
...
screen about():
    ...
    ## Это использует значение, включённое в экран игрового меню. Дочерний vbox
    ## включён в видимость внутри экрана игрового меню.
...
screen file_slots(title):
    ...
    use game_menu(title):
        ...
        fixed:
            ...
            ## Это гарантирует, что событие входа будет выполняться перед чем
            ## либо.
            order_reverse True
...
## Экран настроек ##############################################################
##
## Экран настроек позволяет пользователю настраивать игру, чтобы она лучше для
## него подходила.
##
        ...
        vbox:
            ...
            hbox:
                ...
                if renpy.variant("pc"):
                    ...
                    vbox:
                        style_prefix "radio"
                        label _("Режим экрана") xalign 50 yalign 0
...
## особенного, он имеет доступ к истории диалогов, хранённом в _history_list.
##
    ...
    use game_menu(_("История"), scroll=("vpgrid" if gui.history_height else "viewport")):
        ...
        for h in _history_list:
            ...
            window:
                ...
                ## Это всё правильно уравнивает, если history_height установлен
                ## на None.
                has fixed:
                    yfit True
...
## Экран помощи ################################################################
##
## Экран, дающий информацию о кнопках управления. Он используется другие экраны
...
screen keyboard_help():
    ...
    hbox:
        label _("Пробел")
        text _("Прохождение диалогов, но не позволяет делать выбор.")
    ...
    hbox:
        label _("Page Up")
        text _("Возврат назад по сюжету игры.")
